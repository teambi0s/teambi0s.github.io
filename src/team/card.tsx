...
const MemberCard = ({ firstname, lastname, username = null, team = null, affiliation = null, linkedin = null, twitter = null, email = null }) => (
    <div className="w-100 sm:w-1/2 lg:w-1/3 xl:w-1/4 p-3">
